        ...
        <div>
            <Layout>
                ...
                <Content style={{ padding: '0 115px' }}>
                    <Layout className="site-layout-background" style={{ padding: '24px 0', marginTop: '73px', height: '100vh' }}>
                ...
                <Footer style={{ textAlign: 'center' }}>Made By Nguyễn Phương Thảo</Footer>
            </Layout>
        </div>
    )
}
